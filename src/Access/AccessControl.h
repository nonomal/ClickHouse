...
public:
    ...
    void setConfigDefinedProfilesForSQLUsersAllowed(bool allow) { allow_config_defined_profiles_for_sql_defined_users = allow; }
    bool isConfigDefinedProfilesForSQLUsersAllowed() const { return allow_config_defined_profiles_for_sql_defined_users; }
...
private:
    ...
    std::atomic_bool allow_config_defined_profiles_for_sql_defined_users = true;
};
